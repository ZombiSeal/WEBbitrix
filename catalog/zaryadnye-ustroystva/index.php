...
<?$APPLICATION->IncludeComponent("bitrix:catalog", "main_catalog", Array(
    ...
    "DETAIL_SLIDER_PROGRESS" => "N",	// Показывать полосу прогресса
    ...
    "LIST_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'2','BIG_DATA':false},{'VARIANT':'2','BIG_DATA':false},{'VARIANT':'2','BIG_DATA':false},{'VARIANT':'2','BIG_DATA':false}]",	// Вариант отображения товаров
    ...
    "MESS_BTN_COMPARE" => "",	// Текст кнопки "Сравнение"
    ...
    "TOP_PRODUCT_BLOCKS_ORDER" => "props,sku,price,quantity,quantityLimit,buttons",	// Порядок отображения блоков товара
