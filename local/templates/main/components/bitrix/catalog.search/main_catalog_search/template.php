            ...
            <div class="sort mob-hidden">
                ...
                <ul class="sort__opt">
                    <li <?php if ($_GET["sort"] == "property_price" && $_GET["method"] == "asc"):?> class="selected" <?endif;?>>
                        <a href="?q=<?=$_GET['q']?>&sort=property_price&method=asc" title="">Дешёвые</a>
                    </li>
                    <li <?php if ($_GET["sort"] == "property_price" && $_GET["method"] == "desc"):?> class="selected" <?endif;?>>
                        <a href="?q=<?=$_GET['q']?>&sort=property_price&method=desc" title="">Дорогие</a>
                    </li>
                    <li <?php if ($_GET["sort"] == "id" || empty($_GET["sort"])):?> class="selected" <?endif;?>>
                        <a href="?q=<?=$_GET['q']?>&sort=id&method=asc" title="">Все</a>
                    </li>
